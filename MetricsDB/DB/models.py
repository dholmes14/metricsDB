...
class Nextseq_Metrics(models.Model):
    ...
    mean_cluster_density= models.FloatField(db_column='mean_cluster_density_(k/mm2)', blank=True, default=0.0)
    clusters_PF= models.FloatField(db_column='percentage_clusters_PF', blank=True, default=0.0)
    indexed_reads= models.FloatField(db_column='indexed_reads_PF_(M)', blank=True, null=True, default=0.0)
    RT_yield_GB= models.FloatField(db_column='real-time_yield_(Gb)', blank=True, default=0.0)
    demux_yield_GB= models.FloatField(db_column='yield_(Gb)', blank=True, default=0.0)
    bases_Q30= models.FloatField(db_column='percentage_bases_>Q30', blank=True, default=0.0)
    raw_demux_yield_ratio= models.FloatField(db_column='raw:demux_yield_ratio', blank=True, default=0.0)
    Pass_fail= models.CharField(max_length=200, blank=True, default=0.0)
    Notes= models.CharField(max_length=300, blank=True, default=0.0)
